...
from .data_utils import get_lengths_from_binary_sequence_mask, sort_batch_by_length
...
class _EncoderBase(torch.nn.Module):
    ...
    def sort_and_run_forward(
            ...
            module: Callable[[PackedSequence, Optional[RnnState]],
                             Tuple[Union[PackedSequence, torch.
                                         Tensor], RnnState]],
            inputs: torch.Tensor,
            mask: torch.Tensor,
    ...
    def _get_initial_states(
            self, batch_size: int, num_valid: int,
        ...
        if batch_size > self._states[0].size(1):
            ...
            for state in self._states:
                ...
                zeros = state.data.new(
                    state.size(0), num_states_to_concat,
    ...
    def _update_states(self, final_states: RnnStateStorage,
        ...
        new_unsorted_states = [
            state.index_select(1, restoration_indices)
