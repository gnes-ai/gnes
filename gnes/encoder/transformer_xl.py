...
class TransformerXLEncoder(BaseEncoder):
    ...
    def __init__(self,
        ...
        self._model = TransfoXLModel.from_pretrained(model_dir)
        self._model.eval()
    ...
    def __setstate__(self, d):
        ...
        self._tokenizer = TransfoXLTokenizer.from_pretrained(self.model_dir)
        self._model = TransfoXLModel.from_pretrained(self.model_dir)
        self._model.eval()
