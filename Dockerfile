...
RUN wget https://s3.eu-central-1.amazonaws.com/alan-nlp/resources/embeddings-v0.4/lm-multi-forward-fast-v0.1.pt; mkdir /root/.flair/embeddings/; mv lm-multi-forward-fast-v0.1.pt /root/.flair/embeddings/
